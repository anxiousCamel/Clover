...
```dataview
TABLE source_file, type FROM #community/Module:_param.extractor.ts
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Module agent-engine.ts]]
- 3 edges to [[_COMMUNITY_Module heuristic.gate.ts]]
- 2 edges to [[_COMMUNITY_Storage & Persistence]]
- 2 edges to [[_COMMUNITY_Module ollama.client.ts]]
- 1 edge to [[_COMMUNITY_Module memory.service.ts]]
