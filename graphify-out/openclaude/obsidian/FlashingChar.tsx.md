---
source_file: "src\components\Spinner\FlashingChar.tsx"
type: "code"
...
## Connections
- [[FlashingChar()]] - `contains` [EXTRACTED]
- [[getTheme()]] - `imports` [EXTRACTED]
- [[ink.ts]] - `imports_from` [EXTRACTED]
- [[interpolateColor()]] - `imports` [EXTRACTED]
- [[parseRGB()]] - `imports` [EXTRACTED]
- [[theme.ts]] - `imports_from` [EXTRACTED]
- [[toRGBColor()]] - `imports` [EXTRACTED]
