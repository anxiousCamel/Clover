...
const INTENT_PATTERN_PT =
  /\b(melhor(ar?|e)|edit(ar?|e)|cri(ar?|e)|alter(ar?|e)|corrig(ir|e|a)|escrev(er|a)|modific(ar?|e)|atualiz(ar?|e)|refator(ar?|e)|implement(ar?|e)|desenvolv(er|a)|program(ar?|e)|consert(ar?|e)|pode.*(criar|editar|melhorar|alterar|escrever|modificar|atualizar))\b/i;

const INTENT_PATTERN = {
  test: (msg: string) => INTENT_PATTERN_EN.test(msg) || INTENT_PATTERN_PT.test(msg),
};
